    ...
    >
      <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
        <h1
         ...
         >IMAGINATION CREATES REALITY</h1>
        ...
        <div className="mx-auto flex w-[100%] flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
          <div className="mb-10 flex w-[100%] flex-col gap-4 text-[18px] font-medium  leading-relaxed tracking-wide text-[#363130] md:mb-16 md:gap-6 md:text-[20px] md:leading-relaxed lg:mb-16  lg:max-w-[90%] lg:text-[24px] ">
            <p>Hassan "Abo hadid" Yousif is an artist, driven by creating exquisite and unique imagery that positively impacts people’s lives.</p>
            <p>Currently, I’m working on some exciting projects that I can’t wait to share with you. But I’m always open to new opportunities and collaborations.</p>
